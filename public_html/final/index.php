...
<div class="mx-auto my-16 max-w-7xl px-4">
  <div class="text-center">
    <h1 class=" font-bold tracking-tight text-gray-900  text-6xl">
      Welcome to <span class="text-indigo-600">JAWN</span> Clips
    </h1>
    <p class="mx-auto mt-3 max-w-md text-base text-gray-500 max-w-3xl text-xl">Professionally cutting hair for over 100
      years.</p>
    <a href="#"
