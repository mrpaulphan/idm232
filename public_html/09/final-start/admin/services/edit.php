...
$service = get_service_by_id($_GET['id']);
?>
      ...
      <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            <form action="<?php echo site_url(); ?>/_includes/process-edit-services.php" method="POST">
              <div class="block">
                <label for="">Name</label>
                <input class="border-black border-2" type="text" name="name" value="<?php echo $service['name']; ?>">
              </div>
              <div class="block">
